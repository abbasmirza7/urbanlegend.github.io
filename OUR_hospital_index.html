...
<body>
	...
	<div class="top">
		<div>
		 Contact Us +91 7075810421 / 01 | OUR@hospital.com 
		</div>
	</div>
	...
	<div class="logo">
		<div>
			<table>
				<tr>
					<td width="600px" style="font-size:50px;font-family:forte;"> <font color="#428bca"> OUR  </font><font color="#000"> Hospital</font> </td>
					<td> <br> <br>
						<font size="4px"> 
...
OUR hospital is a health care institution providing patient treatment with specialized medical and nursing staff and medical equipment.Hospitals are reservoirs of critical resources and knowledge <br><br>
...
<ul>
<li> Emergency and trauma care
<li>Mental health services
<li>Obstetrics care
<li>Paediatric care
<li>Rehabilitation services
<li>Surgery care and anaesthesia
</ul>
<br>
 </td>
	...
	<div class="nav_down">
		<div>
		 &copy; OUR Hospital, site designed & developed by beulah_ali_geethika 
		</div>
	</div>
